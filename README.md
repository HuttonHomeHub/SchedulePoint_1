...
> **Project status: SchedulePoint is substantially built.** 23 API modules, 29
> Prisma models across 57 migrations, a React client with 35 flag-scoped
> Playwright suites beside the base journey, and 102 ADRs — **re-derived by
