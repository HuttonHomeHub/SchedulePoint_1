...
> **Project status: SchedulePoint is substantially built.** 23 API modules, 31
> Prisma models across 63 migrations, a React client with 42 Playwright
> suites beside the base journey, and 133 ADRs — **re-derived by
