...
> **Project status: SchedulePoint is substantially built.** 22 API modules, 29
> Prisma models across 54 migrations, a React client with 31 flag-scoped
> Playwright suites beside the base journey, and 92 ADRs — **re-derived by
