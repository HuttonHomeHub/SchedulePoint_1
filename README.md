...
> **Project status: SchedulePoint is substantially built.** 23 API modules, 32
> Prisma models across 66 migrations, a React client with 44 Playwright
> suites beside the base journey, and 147 ADRs — **re-derived by
