...
> **Project status: SchedulePoint is substantially built.** 21 API modules, 28
> Prisma models across 50 migrations, a React client with 29 flag-scoped
> Playwright suites beside the base journey, and 86 ADRs — **re-derived by
