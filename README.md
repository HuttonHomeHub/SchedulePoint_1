...
> **Project status: SchedulePoint is substantially built.** 24 API modules, 32
> Prisma models across 69 migrations, a React client with 45 Playwright
> suites beside the base journey, and 152 ADRs — **re-derived by
