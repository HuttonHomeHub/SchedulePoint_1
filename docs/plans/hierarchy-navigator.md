...
| Q2 decorators / Q3 node-click — **critical open**            | med        | med    | Confirm at approval; defaults stated (no decorators in v1 / node navigates+toggles). Rail scope resolved (persistent shell, all org routes). |
