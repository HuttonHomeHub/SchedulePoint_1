...
| 136 | **The Gantt's M5 remainder: columns chooser, bar labels, Indent/Outdent, Insert activity, view memory** — _named unbuilt by ADR-0095 rather than implied_                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | M5 shipped **T3 only** (the row menu from the shared registry). T1 (Duration/Float/Predecessors columns plus a **Columns** chooser), T2 (bar labels beside bars with a level-of-detail rule), T4 (Indent/Outdent through the existing ADR-0063 M4b reparent batch), T5 (Insert activity with the row's parent pre-set) and T6 (sort, collapse set and columns in typed URL search params) are not built.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | The chart reads as a programme but does not yet come back the way it was left, and a planner cannot choose what the grid shows. None is a defect in what shipped; each is an absent capability, which is why they are a row rather than a silence.                                                                                                              | Pick up as a follow-on. T6 carries the TECH_DEBT #96 trap — the router JSON-parses every search param, so `?x=1` arrives as a **number** — and needs a journey case, because that class is invisible to unit tests that mock `useSearch`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| 137 | **The keyboard-shortcuts sheet does not open while the Gantt is on screen** — _found 2026-08-17 by ADR-0095's M6 ux gate_                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | `useRegisterShortcutsAction` runs unconditionally (`plan-workspace-toolbar.tsx`), but `showShortcuts` only sets `canvasUi.setShowHelp(true)` and `TsldShortcutsHelp` is mounted **inside `TsldPanel`**, which is not rendered in the Gantt view. So the account-menu item and the `?` binding set state nothing renders.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | A lit-but-inert control, in the view that just gained F2, Enter, Escape, Tab-to-commit, `Alt+←/→` and `Shift+←/→` and has no other place documenting them.                                                                                                                                                                                                      | Deliberately **not** patched in the gate pass: the sheet's content is canvas bindings, so making it open in the Gantt without adding that view's own set would answer the wrong question. A milestone, not a fix.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
