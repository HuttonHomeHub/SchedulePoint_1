...
| 138 | **The Gantt-editing gate pass's non-blocking half** — _raised 2026-08-18 by the reconciliation pass's three specialist reviewers_                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | Four findings that were real but not worth blocking the pass on: (a) `GanttRowMenu`'s `?? 'You are not editing this plan.'` fallback is currently DEAD — `scheduleRefusal` is always defined when `canEditSchedule` is false — but hard-codes the pen framing, so a future host wiring `rowStructure` without it would tell a Viewer to start editing; (b) the `View ▾` Columns checkboxes are hand-rolled rather than `CheckboxField`, so they miss its `min-h-6` 2.5.8 hit-target floor — pre-existing local convention shared with zoom/colour-mode/lenses, so a panel-wide migration, not a one-off; (c) `GANTT_COLUMN_LABELS` is `Record<string, string>` rather than keyed by `GanttColumnKey`, losing the guarantee that every column has a label; (d) two comments still name `TsldShortcutsHelp` after the rename.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | (a) is a plausible-but-false sentence waiting for a second host — the ADR-0060 defect shape. (b) is a real 2.5.8 gap on a pointer target. (c) lets a missing label return `undefined` silently. (d) is ordinary drift.                                                                                                                                          | (a) delete the fallback and require `penRefusal` when `canEditSchedule` is false, so a wrong host fails loudly. (b) migrate the whole `View ▾` panel onto `CheckboxField` in one change. (c) one-line type narrowing. (d) rename in place. None gates a release.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
