...
| 138 | **The `View ▾` panel's checkbox chrome is still hand-rolled** — _raised 2026-08-18 by the reconciliation pass's component review; the other three items of this row were closed the same day_                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | The six checkbox/radio rows in the `View ▾` panel are hand-rolled `<label><input>` pairs rather than `CheckboxField`, whose docblock names centralising exactly this chrome as its own job. The **measured defect** — all six missing the WCAG 2.2 SC 2.5.8 ≥24px pointer target — is fixed: they now share one `TOGGLE_ROW` constant carrying `min-h-6 py-1`. What is left is the duplication itself.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | Low. The accessibility gap is closed and a seventh copy can no longer be written without the floor, since there is one constant rather than six literals. The residue is that `CheckboxField`'s other behaviours (`aria-describedby` wiring, density, ref forwarding) are re-implemented here rather than inherited, so a fix to that primitive does not reach this panel. | Migrate the panel onto `CheckboxField` (and a radio sibling, which does not exist yet — that is the reason this was not done in one go). These are controlled toggles in a menu panel while `CheckboxField` forwards a ref for RHF `register()`, so the primitive needs a controlled path first. Not release-gating.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
