...
| 135 | **The Gantt ignores the scheduling mode: a VISUAL plan's bars are drawn from the wrong columns** — _found 2026-08-17 by the Gantt-editing plan's architecture review, by reading rather than from a report_                                                                                                                                                                                                                                                                                                                                                                                                                                                      | `layout/bar-geometry.ts:52` destructures `earlyStart`/`earlyFinish` **unconditionally**. The canvas is handed `barDateSourceFor(plan.schedulingMode, lateOverlay)` (`plan-workspace-toolbar.tsx:461-467`) and reads `visualEffectiveStart` in VISUAL mode (`to-render-model.ts:46`); `GanttPanel`'s props carry **no date source at all** (zero matches for `barDateSource`). These are distinct persisted columns — `visualStart` is the planner's placement input, `visualEffectiveStart` is where the bar actually renders (ADR-0033).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | **In a VISUAL-mode plan the Gantt and the TSLD disagree about where every hand-placed bar sits**, and each looks internally consistent, so only a planner comparing the two views of the same plan would ever see it. It also blocks ADR-0059 M5's VISUAL drag: the write would land and the bar would not move.                                                | Give `GanttPanel` the same `barDateSource` seam the canvas has. Scheduled as a **read-only M0 slice of the Gantt-editing epic**, before its M3 — it repairs this, adds no affordance and is coherent alone.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| 136 | **The Gantt's M5 remainder** — _CLOSED 2026-08-18_                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | M5 shipped the row menu (T3), bar labels (T2) and the constraint badge; T1 (a Columns chooser plus a Predecessors column), T4 (Indent/Outdent through the existing ADR-0063 M4b reparent batch), T5 (Insert activity with the row's parent pre-set) and T6 (sort, hidden columns and the collapse set in typed URL search params) were not built. **All four have now landed**, with `apps/web/e2e-gantt-editing/view-state.spec.ts` driving them against a real API.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | The chart now comes back the way it was left, and a planner can choose what the grid shows.                                                                                                                                                                                                                                                                     | **Closed.** Two scope calls are recorded rather than silently dropped: **grid width is NOT stored** (the plan lists it, but the grid has no resize handle, so nothing can set it — storing a value no control produces is state claiming a capability the surface lacks), and the **collapse set is capped at 40 ids** with the withheld count reported, because 36-character ids otherwise build a URL that gets truncated in transit and half-restores a view while looking deliberate.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| 137 | **The keyboard-shortcuts sheet does not open while the Gantt is on screen** — _CLOSED 2026-08-18_                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | `TsldShortcutsHelp` was mounted **inside `TsldPanel`**, which the Gantt does not render, so the account-menu item and the `?` binding set `showHelp` and nothing drew it. The state was always shared (`use-tsld-canvas-ui-state`); only the render was trapped one level down.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | A lit-but-inert control, in the view that had just gained F2, Enter, Escape, Tab-to-commit, `Alt+←/→` and `Shift+←/→` with no other place documenting them.                                                                                                                                                                                                     | **Closed.** Renamed `PlanShortcutsHelp` and mounted ONCE at the workspace, above both views, with a `view` prop selecting the set. Deliberately **two lists, not one merged list**: the views share key NAMES and not meanings — Enter opens the logic editor on the canvas and commits a cell edit in the grid — so a combined sheet would qualify half its rows into unreadability.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
