...
| 136 | **The Gantt's M5 remainder: columns chooser, bar labels, Indent/Outdent, Insert activity, view memory** — _named unbuilt by ADR-0095 rather than implied_                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | M5 shipped the row menu (T3), bar labels (T2) and the constraint badge. T1 (Duration/Float/Predecessors columns plus a **Columns** chooser), T4 (Indent/Outdent through the existing ADR-0063 M4b reparent batch), T5 (Insert activity with the row's parent pre-set) and T6 (sort, collapse set and columns in typed URL search params) are not built.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | The chart reads as a programme but does not yet come back the way it was left, and a planner cannot choose what the grid shows. None is a defect in what shipped; each is an absent capability, which is why they are a row rather than a silence.                                                                                                              | Pick up as a follow-on. T6 carries the TECH_DEBT #96 trap — the router JSON-parses every search param, so `?x=1` arrives as a **number** — and needs a journey case, because that class is invisible to unit tests that mock `useSearch`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
