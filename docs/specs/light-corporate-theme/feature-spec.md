...
| C4  | "How many declarations are at `:root`?"                                                                                                                         | **271**, and they are not one population: **182 literal colours**, **53 `var()` aliases** (31 unqualified + 22 `--plot-*`), **35 non-colour** (1 radius, 3 metrics, 5 weights, 24 type, 2 font stacks). The coordinator's "~40 non-colour" is **35**.                                                                                                                                                                                                                                               | **The re-derivation is 182 numbers, not 271.** §3.1.                                                                                                                               |
...
| `var()` aliases at `:root`             | **53**  | `rg -c '^\s+--[a-z-]+: var\(--page-'`                                                 |
