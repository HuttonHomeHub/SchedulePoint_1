...
| ADR-0026 §9's budget has never been measured on its stated hardware                                 | **certain** | med    | Out of scope to close (`TECH_DEBT` #59). This epic must not make it worse and must not claim to have measured it.                                                                                                      |
