...
| The 14.5 % between-run variance sits in the web suites                              | unknown                  | low    | M4 captures segments across three runs; 15.8 % of packing slack absorbs a good deal of it                                        |
