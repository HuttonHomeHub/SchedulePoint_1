...
- [#651](https://github.com/HuttonHomeHub/SchedulePoint_1/pull/651) [`5a53722`](https://github.com/HuttonHomeHub/SchedulePoint_1/commit/5a53722d989f8b6d16361b986be38196b2e961e0) Thanks [@HuttonHomeHub](https://github.com/HuttonHomeHub)! - Drop `plans.scheduling_mode` and the `SchedulingMode` enum, one release after the collapse.
...
- [#637](https://github.com/HuttonHomeHub/SchedulePoint_1/pull/637) [`fcaba7c`](https://github.com/HuttonHomeHub/SchedulePoint_1/commit/fcaba7c7d9588f838bcfeaa5bb99a5438de091d7) Thanks [@HuttonHomeHub](https://github.com/HuttonHomeHub)! - Staff diagnostics gains eight entries sizing the estate ahead of the
  ...
  constraint currently does, how many of those a full baseline could restore, and
  how many placements sit on a plan still in Early mode. Read-only counts with no
  caller input, like every other entry in the registry.

  _(This entry said "seven" and named three of the four constraint-population
  counts when it shipped in `0.69.0`. The changeset was written before the
  Early-mode reading was added and was never re-read against what landed —
  a count nobody re-derived, in a permanent user-facing artefact.)_
...
- [#618](https://github.com/HuttonHomeHub/SchedulePoint_1/pull/618) [`ecc3f8e`](https://github.com/HuttonHomeHub/SchedulePoint_1/commit/ecc3f8e9d9e73d4ad8d9a877030768c2b35e22f8) Thanks [@HuttonHomeHub](https://github.com/HuttonHomeHub)! - "Where the work stands" puts flagged programmes first, so a broken constraint is the first thing the
...
- [#582](https://github.com/HuttonHomeHub/SchedulePoint_1/pull/582) [`e2fcc81`](https://github.com/HuttonHomeHub/SchedulePoint_1/commit/e2fcc8146e3fe3d23cfc281d5b9db0906898635b) Thanks [@HuttonHomeHub](https://github.com/HuttonHomeHub)! - Add `GET /api/v1/staff/diagnostics` — counts, and nothing else (ADR-0140).
  ...
  Two diagnostics ship: the driving-resource day-factor divergence `docs/TECH_DEBT.md` [#86](https://github.com/HuttonHomeHub/SchedulePoint_1/issues/86)'s M0-T3
...
- [#580](https://github.com/HuttonHomeHub/SchedulePoint_1/pull/580) [`0db3493`](https://github.com/HuttonHomeHub/SchedulePoint_1/commit/0db3493b6e74704997ef2e37693f435214604651) Thanks [@HuttonHomeHub](https://github.com/HuttonHomeHub)! - Float is measured in the same days as the duration beside it.
...
- [#578](https://github.com/HuttonHomeHub/SchedulePoint_1/pull/578) [`13f8329`](https://github.com/HuttonHomeHub/SchedulePoint_1/commit/13f8329fce7256c18f1b2ce50d4f718fe8af971e) Thanks [@claude](https://github.com/apps/claude)! - A duration is measured on the calendar the work happens on.
...
- [#491](https://github.com/HuttonHomeHub/SchedulePoint_1/pull/491) [`5d84bd0`](https://github.com/HuttonHomeHub/SchedulePoint_1/commit/5d84bd051d0606a95db589e5fb9365c3414886af) Thanks [@HuttonHomeHub](https://github.com/HuttonHomeHub)! - Add the cross-plan revision comparison: compare a revision of one plan against a
...
- [#474](https://github.com/HuttonHomeHub/SchedulePoint_1/pull/474) [`57da30b`](https://github.com/HuttonHomeHub/SchedulePoint_1/commit/57da30b7c2e288104b4651a894b2f4ddb298b80a) Thanks [@HuttonHomeHub](https://github.com/HuttonHomeHub)! - Freeze the criticality rule a baseline's snapshot was computed under. Four nullable columns on
...
- [#365](https://github.com/HuttonHomeHub/SchedulePoint_1/pull/365) [`15ceba8`](https://github.com/HuttonHomeHub/SchedulePoint_1/commit/15ceba8e239d6500e76a56c0aae059627d315bfe) Thanks [@HuttonHomeHub](https://github.com/HuttonHomeHub)! - Add `accounts.issuer` ahead of the Better Auth 1.7 upgrade.
...
- [#232](https://github.com/HuttonHomeHub/SchedulePoint_1/pull/232) [`1657e38`](https://github.com/HuttonHomeHub/SchedulePoint_1/commit/1657e38b52a4dfd37b27e8e6a6f7de7d06012779) Thanks [@HuttonHomeHub](https://github.com/HuttonHomeHub)! - Reconciliation pass at the ADR-0073 epic boundary (`docs/RECONCILE.md`, ADR-0058), and the two
  ...
  **Corrected: "a verification failure fails the sign-up" was false.** Better Auth invokes the mail
  ...
  that a broken relay is visible only as an unstructured log line — is `docs/TECH_DEBT.md` [#94](https://github.com/HuttonHomeHub/SchedulePoint_1/issues/94).
...
- [#231](https://github.com/HuttonHomeHub/SchedulePoint_1/pull/231) [`746220c`](https://github.com/HuttonHomeHub/SchedulePoint_1/commit/746220c412ebd4f28370f0b41c131b6f8792b962) Thanks [@HuttonHomeHub](https://github.com/HuttonHomeHub)! - Let the audit reads be narrowed by action, outcome and date range.
