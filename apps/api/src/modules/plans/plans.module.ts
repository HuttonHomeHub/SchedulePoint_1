 ...
 * active parent project), and the shared HierarchyLifecycleService (soft-delete
 * + restore; a plan is a leaf, so delete cascades to nothing).
 */
@Module({
  imports: [OrganizationsModule, HierarchyModule, ProjectsModule],
