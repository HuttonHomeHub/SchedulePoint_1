 ...
 *
 * `sign-up.mjs:163` + `sign-up.mjs:203-241`: with `requireEmailVerification`, an address that **already exists**
...
describe.skipIf(!hasDatabase)('A broken mail transport (e2e)', () => {
  ...
  describe('the sign-up guarantee that decides the design (ADR-0075)', () => {
     ...
     * synthetic 200 carrying a fabricated user id, and sends nothing (`sign-up.mjs:163` + `sign-up.mjs:203-241`). It
