 ...
 * and collapsible; the leading edge belongs to the 48 px {@link ToolRail} and this is the first
...
export function NavigatorRail({
   ...
   * guarantee a compiler check rather than a comment — the same argument as `ToolRail`'s
   * `explorerAvailable` not being defaulted.
   */
  orgSlug: string;
  ...
  return (
    ...
    <nav aria-label="Project Explorer" className="border-border flex h-full min-h-0 flex-col">
      ...
      {onClose ? <OrgDestinations orgSlug={orgSlug} /> : null}
