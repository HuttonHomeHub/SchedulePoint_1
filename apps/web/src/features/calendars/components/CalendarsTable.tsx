 ...
 *
 * It also shows which **tier** each calendar belongs
...
export function CalendarsTable({
  ...
  const calendars = useCalendars(orgSlug, scopeFilter, {
    q: debouncedSearch,
  ...
  const projectNames = useCalendarProjectNames(orgSlug, calendars.data);
